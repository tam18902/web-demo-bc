...
const BlockchainItem = (props) => {
    const { block, data, prev, hash } = props.item;
        ...
        <div className="single_item">
            <div className="well well-success" id="block1chain1well">
                <form className="form-horizontal">
                    ...
                    <div className="form-group">
                        <h6 className="col-sm-2 control-label" for="block1chain1data">Data:</h6>
                        <div className="col-sm-10">
                            <textarea className="form-control" id="block1chain1data" rows="5"></textarea>
                        </div>
                    </div>
